...
const Hero = () => {
  ...
  const role = useRoleSwitcher({ roles: ['FULLSTACK DEVELOPER', 'PYTHON DEVELOPER', 'JAVASCRIPT DEVELOPER'] })
    ...
    <section className="bg-primary bg-small-glow bg-small-glow-position md:bg-large-glow-position lg:bg-large-glow min-h-[calc(dvh-4rem)] bg-no-repeat">
      <div className="mx-auto grid max-w-[1200px] grid-cols-1 items-center gap-4 px-4 pt-12 pb-10 md:grid-cols-2 lg:p-4">
        <div className="flex min-h-48 flex-col justify-between lg:min-h-56 lg:max-w-[33.75rem]">
          <h1>
            <span className="text-neutral mb-2 block text-3xl font-bold">Hi - I'm Marta Kozma</span>
            <span className="text-accent block text-[1.75rem] font-bold">{role}</span>
          </h1>

          <h2 className="text-neutral mt-3">
          Building intelligent, scalable, and high-performance digital solutions from front to back.
          </h2>

          <div className="mt-6 flex flex-wrap gap-6">
            <a
              href="https://github.com/kozmarti"
              aria-label="View GitHub Profile"
              className="bg-accent min-w-32 cursor-pointer rounded-lg px-[14px] py-[10px] text-center text-sm font-medium text-[#00071E]">
              GitHub
            </a>
            <a
              href="https://www.linkedin.com/in/marta-kozma/"
